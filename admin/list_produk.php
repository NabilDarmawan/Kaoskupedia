          ...
          <div class="card-body ">
           ...
           <!--   <input type="hidden" value="<?php //echo $_SESSION['id'];?>" name="id">-->
            ...
            <table class="table mt-3">
                ...
                <tbody>
                <?php
                $tampil = mysqli_query($con, "SELECT tb_user.nama, tb_produk.id_produk, tb_produk.nama_produk, tb_produk.foto_produk, tb_produk.harga_produk, tb_produk.ukuran_produk, tb_produk.deskripsi_produk FROM tb_produk JOIN tb_user ON tb_produk.id=tb_user.id");
                $no=1;
