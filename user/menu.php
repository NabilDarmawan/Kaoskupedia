   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top ">
    ...
    <div class="row no-gutters mt-5"><!-- menu -->
      ...
      <div class="col-md-10  mt-3">
        ...
        <!-- tampilan Poduk -->
        <?php
            $produk = mysqli_query($con, "SELECT tb_produk.nama_produk, tb_produk.foto_produk, tb_produk.harga_produk, tb_produk.ukuran_produk, tb_produk.deskripsi_produk, tb_user.no_telp FROM tb_produk JOIN tb_user ON tb_produk.id = tb_user.id");
