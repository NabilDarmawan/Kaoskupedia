    ...
    <div class="row no-gutters mt-5"><!-- menu -->
      ...
      <div class="fixed-top col-md-2 mt-5">
        ...
        <!-- bar-->
            ...
            <li class="nav-item">
              <a class="nav-link   active text-white" href="list_produk.php"><i class="fas fa-store-alt mr-2"></i></i>Produk Saya</a><hr class="bg-secondary">
            </li>
            <li class="nav-item">
      ...
      <div class="container-md mt-5">
        ...
        <!--<form action="export_excel.php" method="POST">
            ...
            <table class="table mt-3">
                ...
                $id= $_SESSION['id'];
                $cari = $_GET['cari'];
                $tampil = mysqli_query($con,"SELECT * FROM tb_produk WHERE id='$id' and ukuran_produk = '$cari'");
                $no=1;
